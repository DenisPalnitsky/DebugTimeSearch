...
namespace VariableExplorer_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(MyCompany.VariableExplorer.GuidList.guidVariableExplorerCmdSet, (int)MyCompany.VariableExplorer.PkgCmdIDList.cmdidMyCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VariableExplorer", "MyCompany.VariableExplorer.VariableExplorerPackage");
