...
using MyCompany.VariableExplorer;

namespace VariableExplorer_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VariableExplorerPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(MyCompany.VariableExplorer.GuidList.guidVariableExplorerCmdSet, (int)MyCompany.VariableExplorer.PkgCmdIDList.cmdidMyCommand);
